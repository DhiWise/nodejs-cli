...
async function seedUser () {
  try {
    ...
    userToBeInserted = await userDbService.findOne({ 'username':'Wellington_Marquardt' });
    if (!userToBeInserted) {  
      userToBeInserted = {
      ...
      await userDbService.updateByQuery({ 'username':'Wellington_Marquardt' }, userToBeInserted);
    }
    userToBeInserted = await userDbService.findOne({ 'username':'Delmer89' });
    if (!userToBeInserted) {  
      userToBeInserted = {
      ...
      userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
      await userDbService.updateByQuery({ 'username':'Delmer89' }, userToBeInserted);
    }
